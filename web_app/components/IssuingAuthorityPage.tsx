...
const IssuingAuthorityPage: React.FC = () => {
      ...
      <Container className={styles.page}>
        <Row className="mt-5">
          <Col className="text-center">
            <Button href="/ia/generate" className={styles.proceedButton}>
              Proceed to Issue Certificate
            </Button>
          </Col>
        </Row>
        <Row>
          <h2 className={styles.sectionTitle}>Previously Issued Documents</h2>
...
export default IssuingAuthorityPage;
